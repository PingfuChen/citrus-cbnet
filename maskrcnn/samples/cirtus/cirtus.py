...
def train(model):
    ...
    dataset_train.load_cirtus(os.path.join(ROOT_DIR, "imagedata_json"), "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = BalloonDataset()
    dataset_val.load_cirtus(os.path.join(ROOT_DIR, "imagedata_json"), "val")
    dataset_val.prepare()
